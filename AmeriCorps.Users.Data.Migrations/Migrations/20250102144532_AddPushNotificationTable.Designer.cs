...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.CityOfBirth", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_city_of_birth");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_city_of_birth_user_id");

                    b.ToTable("city_of_birth", "users");
                });

            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.CountryOfBirth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_country_of_birth");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_country_of_birth_user_id");

                    b.ToTable("country_of_birth", "users");
                });

            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.DateOfBirth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_date_of_birth");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_date_of_birth_user_id");

                    b.ToTable("date_of_birth", "users");
                });
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.EncryptedSocialSecurityNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("SociaSecurityNumber")
                        .HasColumnType("text")
                        .HasColumnName("socia_security_number");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_encrypted_social_security_number");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_encrypted_social_security_number_user_id");

                    b.ToTable("encrypted_social_security_number", "users");
                });

            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.PushNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("push_notification", "users");
                });

            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.StateOfBirth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_state_of_birth");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_state_of_birth_user_id");

                    b.ToTable("state_of_birth", "users");
                });
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.OperatingSite", b =>
                {
                    ...
                    b.Property<double>("AwardedMsys")
                        .HasColumnType("double precision")
                        .HasColumnName("awarded_msys");
                    ...
                    b.Property<double>("LivingAllowanceMsys")
                        .HasColumnType("double precision")
                        .HasColumnName("living_allowance_msys");

                    b.Property<double>("NonLivingAllowanceMsys")
                        .HasColumnType("double precision")
                        .HasColumnName("non_living_allowance_msys");
                    ...
                    b.HasIndex("ContactId")
                        .HasDatabaseName("ix_operating_site_contact_id");
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Project", b =>
                {
                    ...
                    b.Property<double>("TotalAwardedMsys")
                        .HasColumnType("double precision")
                        .HasColumnName("total_awarded_msys");
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.User", b =>
                {
                    ...
                    b.Property<string>("PPIUpdateNote")
                        .HasColumnType("text")
                        .HasColumnName("ppi_update_note");
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.CityOfBirth", b =>
                {
                    b.HasOne("AmeriCorps.Users.Data.Core.User", null)
                        .WithMany("CityOfBirth")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_city_of_birth_users_user_id");
                });

            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.CountryOfBirth", b =>
                {
                    b.HasOne("AmeriCorps.Users.Data.Core.User", null)
                        .WithMany("CountryOfBirth")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_country_of_birth_users_user_id");
                });

            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.DateOfBirth", b =>
                {
                    b.HasOne("AmeriCorps.Users.Data.Core.User", null)
                        .WithMany("DateOfBirths")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_date_of_birth_users_user_id");
                });
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.EncryptedSocialSecurityNumber", b =>
                {
                    b.HasOne("AmeriCorps.Users.Data.Core.User", null)
                        .WithMany("EncryptedSocialSecurityNumbers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_encrypted_social_security_number_users_user_id");
                });

            modelBuilder.Entity("AmeriCorps.Users.Data.Core.Model.StateOfBirth", b =>
                {
                    b.HasOne("AmeriCorps.Users.Data.Core.User", null)
                        .WithMany("StateOfBirth")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_state_of_birth_users_user_id");
                });
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.OperatingSite", b =>
                {
                    b.HasOne("AmeriCorps.Users.Data.Core.User", "Contact")
                        .WithMany()
                        .HasForeignKey("ContactId")
                        .HasConstraintName("fk_operating_site_user_contact_id");
            ...
            modelBuilder.Entity("AmeriCorps.Users.Data.Core.User", b =>
                {
                    ...
                    b.Navigation("DateOfBirths");

                    b.Navigation("DirectDeposits");

                    b.Navigation("Education");

                    b.Navigation("EncryptedSocialSecurityNumbers");
